        ...
        <div className="flex md:order-2">
          <div className="flex align-middle justify-center">
            <button
              ...
              aria-controls="navbar-search"
              aria-expanded="false"
              className="text-gray-500 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-700 focus:outline-none focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-700 rounded-lg text-sm p-2.5 me-1 flex flex-row justify-end cursor-pointer w-fit"
            >
              {" "}
